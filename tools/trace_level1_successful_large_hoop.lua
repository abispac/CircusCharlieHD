...
local columns = {
  ...
  "animation_position_sample", "jump_accumulator", "scroll_command",
  "scroll_accumulator", "course_position_8_8",
...
local function trace_frame()
  ...
  local row = {
    ...
    h8(0x20b3), h16(0x20b5), h16(0x20b1), h16(0x2203),
    h16(0x2203), h16(0x20c2),
    h8(0x2208), h8(0x20bc),
